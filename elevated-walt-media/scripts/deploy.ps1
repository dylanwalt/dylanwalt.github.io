...
$exclude = @('node_modules', '.clasp.json', '.clasprc.json', 'analytics', '_tools', 'assets\video\hero-aerial.mp4', 'assets\video\_hero-build', 'assets\media\safari-plains\raw', 'assets\media\safari-plains\organized', 'assets\media\safari-plains\_vision-cache', 'assets\media\safari-plains\_vision-packs', 'assets\media\safari-plains\_drone-review', 'assets\media\safari-plains\_review-samples', 'assets\media\safari-plains\gallery')

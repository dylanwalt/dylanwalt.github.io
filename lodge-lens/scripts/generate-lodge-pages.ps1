...
<body data-base-path=".." data-lodge-slug="{{SLUG}}" data-admin-hash="{{ADMIN_HASH}}">
  <header class="site-header">
    <div class="container inner">
      <a class="logo-link" href="../" data-admin-trigger>
        <img src="../assets/brand/elevate-walt-media/logo.svg" alt="Elevate Walt Media">
      </a>
    </div>
  </header>
  <main id="main-content"></main>
  <footer class="site-footer container">
    <p>Preview footage is for internal review only · © Elevate Walt Media</p>
  </footer>

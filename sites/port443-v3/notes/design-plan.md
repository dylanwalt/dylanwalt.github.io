...
- `--blue: #3d7bff` — single chroma accent, used on primary CTAs and on
  diagram strokes only. Distinct from Apple's `#0071e3` and from v2's mint.
- `--blue-soft: rgba(61, 123, 255, 0.14)` — focus ring and chip backgrounds.

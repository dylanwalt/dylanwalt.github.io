  ...
  return (
    ...
    >
      <Container className="flex items-center justify-between">
        ...
        <Link
          href="/request-a-demo/"
          className="inline-flex items-center gap-2 bg-[var(--blue)] text-[var(--ivory-2)] px-4 py-2 text-[13px] font-medium tracking-tight hover:opacity-90 transition-opacity rounded-[2px]"
        >
          Request a demo
    ...
    <footer className="border-t border-[var(--ink-3)] bg-[var(--ink)] py-16">
      <Container>
        ...
        <div className="mt-14 pt-7 border-t border-[var(--ink-3)] flex flex-wrap items-center justify-between gap-4 text-[12px] text-[var(--muted-on-ink)]">
          ...
          <span className="mono">
            v3 · rebuilt from the website-rebuild-pro skill
          </span>
        </div>
      </Container>
    </footer>

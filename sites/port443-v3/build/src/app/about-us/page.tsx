        ...
        <section className="py-24 lg:py-32 border-b border-[var(--ink-3)]">
          <Container>
            ...
            <h1 className="mt-6 text-[clamp(2.5rem,6vw,4.5rem)] font-semibold leading-[0.98] tracking-[-0.025em] max-w-4xl">
              ...
              <span className="text-[var(--blue)]">cyber security.</span>
            </h1>
            ...
            <div className="mt-12">
              <Link
                href="/request-a-demo/"
                className="inline-flex items-center gap-2 bg-[var(--blue)] text-[var(--ivory-2)] px-6 py-3 text-[14.5px] font-medium tracking-tight hover:opacity-90 transition-opacity rounded-[2px]"
              >
                Request a demo

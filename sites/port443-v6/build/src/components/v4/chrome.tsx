...
export const BRAND_FULL_LOGO_SRC = "/port443-v6/logo-full.webp"
export const BRAND_MARK_LOGO_SRC = "/port443-v6/logo-mark.webp"
    ...
    <footer className="border-t border-[var(--ink-3)] bg-[var(--ink)] py-16">
      <Container>
        ...
        <div className="mt-14 pt-7 border-t border-[var(--ink-3)] flex flex-wrap items-center justify-between gap-4 text-[12px] text-[var(--muted-on-ink)]">
          ...
          <span className="mono">
            v6 · rebuilt from the website-rebuild-pro skill
          </span>
        </div>
      </Container>
    </footer>

...
const services = [
  ...
  },
  {
    code: "04",
    title: "Consulting",
    sub: "Assessments and advisory.",
    body:
      "Assessments, information security policy, and incident response policy definition and development. Bridges security engineering and executive risk governance.",
    icon: Layers3,
    capabilities: [
        ...
        <section className="py-20 lg:py-28 border-b border-[var(--ink-3)]">
          <Container>
            ...
            <p className="mt-7 max-w-2xl text-[17px] leading-[1.55] text-[var(--muted-on-ink)]">
              ...
              Build → Operate. The scope changes; the discipline does not.
            </p>
          </Container>
        </section>
